...
function App() {
  ...
  function handleFromAmountChange(e) {
    ...
    setPaymentHistory((oldPayments)=>{
      let newHistory=[];
      for(let i=0;i<oldPayments.length;i++){
        if(i>=20){
          break;
        }
        newHistory.push(oldPayments[i]);
      }
      return [<br/>,`${fromAmount} ${fromCurrency} -> ${toAmount} ${toCurrency}`,...newHistory];
    });
  ...
  function handleToAmountChange(e) {
    ...
    setPaymentHistory((oldPayments)=>{
      ...
      return [<br/>,`${toAmount} ${toCurrency} -> ${fromAmount} ${fromCurrency}`,...newHistory];
    });
